...
-(void)buildChartOne
{
    _chartOne = [[PiechartView alloc]initWithFrame:CGRectMake(40, 50, [UIScreen mainScreen].bounds.size.width-100, 200) withStrokeWidth:30 andColor:[UIColor blueColor] andPercent:0.8f andAnimation:YES];
